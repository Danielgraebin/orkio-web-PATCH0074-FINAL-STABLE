    ...
    <div className="min-h-screen">
            ...
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <div className="flex items-center gap-2">
                  <span className="text-lg font-extrabold tracking-wide">ORKIO</span>
      ...
      <section id="what" className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-black tracking-tight md:text-3xl">What is Orkio?</h2>
      ...
      <section id="how" className="border-y border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-12">
          <h2 className="text-2xl font-black tracking-tight md:text-3xl">How Orkio works</h2>
        ...
        <div className="mx-auto max-w-6xl px-4 py-8">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div className="flex items-center gap-3">
              <img src="/orkio-logo.png" alt="Orkio" className="h-8 w-8 rounded-xl" />
              <div>
